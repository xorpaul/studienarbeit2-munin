...
Dazu wird zuerst die Datei \pictext{munin.conf} geparst, um die zu überwachenden Nodes zu ermitteln.
...
In der Abbildung \ref{4times} konnte der \pictext{munin-node} noch keinen kompletten Tag Messwerte sammeln, weshalb die Jahresübersicht noch keine Messwerte liefern kann und nur den Platzhalterwert \textit{nan} (für nicht definiert) enthält.
